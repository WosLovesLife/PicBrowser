 ...
 * ({@link #getGestureController()}).
 * <p/>
 * View position can be animated with {@link ViewPositionAnimator}
 * ({@link #getPositionAnimator()}).
 */
public class GImageView extends SimpleDraweeView implements GestureView, ClipView, AnimatorView {
     ...
     */
    @Override
    public GestureControllerForPager getGestureController() {
        return controller;
    }
